...
extern float _home_dir[3]; // home dirs
  ...
  #define DELTAXY_RAD2DEG (57.2957795)  // to convert RAD to degrees
  extern float delta_segments_per_second;
  extern float delta[3];
  extern float deltaxy_armax;
  extern float deltaxy_armbx;
  extern float deltaxy_armal;
  extern float deltaxy_armbl;
  extern float deltaxy_arma_mountLen;
  extern float deltaxy_arma_mountAngle;
  extern float deltaxy_EX;
  extern float deltaxy_EY;
  extern float deltaxy_lHp2;
  extern float deltaxy_lH;
