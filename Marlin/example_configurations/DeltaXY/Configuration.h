...
//============================= DELTAXY Printer ===============================
//===========================================================================
// For a DeltaXY printer add at front
// #include "example_configurations/DeltaXY/Configuration.h"
// in Configuration.h at Matlin folder
//
...
#define CUSTOM_MACHINE_NAME "PavloG DeltaXY"
...
#define DELTAXY
  ...
  #define DELTAXY_SEGMENTS_PER_SECOND 100

  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them

  // X coordinate of Arm A joint
  #define DELTAXY_ARMAX -15.0 // mm
  // X coordinate of Arm B joint
  #define DELTAXY_ARMBX 15.0 // mm

  // Arm A len
  #define DELTAXY_ARMALEN 50.0 // mm
  // Arm B len
  #define DELTAXY_ARMBLEN 50.0 // mm

  // Arm A mount params
  #define DELTAXY_ARMA_MOUNT_OFFSET 20.0 // mm
  #define DELTAXY_ARMA_MOUNT_ANGLE 35.0 // mm
...
// :[-1,1]
#define X_HOME_DIR -1  // deltaxy always home to min
#define Y_HOME_DIR -1
#define Z_HOME_DIR 1
